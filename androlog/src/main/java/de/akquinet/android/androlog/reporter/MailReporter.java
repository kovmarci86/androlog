 ...
 */
public class MailReporter extends GenericReporter {
	...
	public void configure(Properties configuration) {
		...
		configureMailTo(configuration);
	}

	private void configureMailTo(Properties configuration) {
	...
	public boolean send(Context context, String mes, Throwable err) {
		if (to != null) {
			String report = getConverter().convertReport(
					new Report(context, mes, err));
			...
			try {
				...
				intent.putExtra(Intent.EXTRA_TEXT,
						"- Please add some info to this error report here, thank you -");
	...
	private void writeStringToFile(String string, String destFilePath)
			throws IOException {
