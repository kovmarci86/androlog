...
/**
 * Helper class to create Reporter instance from class names.
 */
public class GenericFactory {
	 ...
	 */
	public static Class<?> load(String clazzName) throws ClassNotFoundException {
		ClassLoader loader = GenericFactory.class.getClassLoader();
		try {
			return (Class<?>) loader.loadClass(clazzName);
